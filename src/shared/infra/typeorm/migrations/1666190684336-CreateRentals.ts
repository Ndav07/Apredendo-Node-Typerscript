...
export class CreateRentals1666190684336 implements MigrationInterface {
    name = 'CreateRentals1666190684336'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "rentals" ("id" uuid NOT NULL, "start_date" TIMESTAMP NOT NULL DEFAULT 'now()', "end_date" TIMESTAMP, "expected_return_date" TIMESTAMP NOT NULL, "total" numeric, "created_at" TIMESTAMP NOT NULL DEFAULT 'now()', "updated_at" TIMESTAMP NOT NULL DEFAULT 'now()', "carId" uuid, "userId" uuid, CONSTRAINT "REL_7e07037bddbd4c16a105cbd904" UNIQUE ("carId"), CONSTRAINT "REL_ffe1d7b0b58588566795452251" UNIQUE ("userId"), CONSTRAINT "PK_2b10d04c95a8bfe85b506ba52ba" PRIMARY KEY ("id"))`);
